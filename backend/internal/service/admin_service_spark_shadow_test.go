...
func (s *sparkShadowRepoStub) ListWithFilters(_ context.Context, _ pagination.PaginationParams, _, _, _, _ string, _ int64, _ string, _ string) ([]Account, *pagination.PaginationResult, error) {
	return nil, nil, nil
}
