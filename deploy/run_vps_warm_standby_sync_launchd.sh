...
export STANDBY_CLEAR_OPENAI_APIKEY_PROXY_IDS="${STANDBY_CLEAR_OPENAI_APIKEY_PROXY_IDS:-true}"
export STANDBY_CLEAR_GROK_PROXY_IDS="${STANDBY_CLEAR_GROK_PROXY_IDS:-true}"
...
exec "${ROOT_DIR}/deploy/sync_to_vps_warm_standby.sh"
