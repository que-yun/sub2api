...
STANDBY_SYNC_OPENAI_OAUTH_PERMANENT_ERRORS="${STANDBY_SYNC_OPENAI_OAUTH_PERMANENT_ERRORS:-false}"
...
WITH updated AS (
  UPDATE public.accounts a
      ...
      rate_multiplier = l.rate_multiplier,
      proxy_id = CASE
        WHEN '${STANDBY_CLEAR_OPENAI_OAUTH_PROXY_IDS}' = 'true' THEN NULL
        WHEN l.proxy_id = 6 THEN NULL
        ELSE l.proxy_id
      END,
